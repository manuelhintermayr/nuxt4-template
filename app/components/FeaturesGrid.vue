<template>
    <div ref="gridContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <FeatureCard 
            ref="featureCards"
            :title="$t('features.nuxt4.title')" 
            :description="$t('features.nuxt4.description')"
        ...
        <FeatureCard 
            ref="featureCards"
            :title="$t('features.nuxtUI.title')" 
            :description="$t('features.nuxtUI.description')"
        ...
        <FeatureCard 
            ref="featureCards"
            :title="$t('features.mouseFollower.title')" 
            :description="$t('features.mouseFollower.description')"
